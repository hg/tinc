...
latest -c $etc/tinc10 <<EOF
  init tinc10
  set Port 30002
  set Interface tinc10
  set Subnet ${addr[tinc10]}
  set Address localhost
  set Compression 10
  set LogLevel 5
EOF

# Remove EC public key or newer nodes will complain about protocol downgrade
sed -i 's#^Ed25519PublicKey##' $etc/tinc10/hosts/tinc10
