...
static const subnet_ipv4_t ipv4_1 = {
	.prefixlength = 24,
	.address = {{0x01, 0x02, 0x03, 0x04}},
};
static const subnet_ipv4_t ipv4_1_pref = {
	.prefixlength = 16,
	.address = {{0x01, 0x02, 0x03, 0x04}},
};
static const subnet_ipv4_t ipv4_2 = {
	.prefixlength = 16,
...
static void test_subnet_compare_mac_neq_address(void **state) {
	...
	node_t owner = {.name = strdup("foobar")};
	const subnet_t a = {.owner = &owner, .type = SUBNET_MAC, .weight = 10, .net = {.mac = {.address = mac1}}};
	const subnet_t b = {.owner = &owner, .type = SUBNET_MAC, .weight = 10, .net = {.mac = {.address = mac2}}};
...
static void test_subnet_compare_ipv4_weight(void **state) {
	...
	const subnet_t a = {.type = SUBNET_IPV4, .weight = 1, .net = {.ipv4 = ipv4_1}};
	const subnet_t b = {.type = SUBNET_IPV4, .weight = 2, .net = {.ipv4 = ipv4_1}};
...
static void test_subnet_compare_ipv4_owners(void **state) {
	...
	const subnet_t a = {.owner = &foo, .type = SUBNET_IPV4, .net = {.ipv4 = ipv4_1},};
	const subnet_t b = {.owner = &foo, .type = SUBNET_IPV4, .net = {.ipv4 = ipv4_1},};
	const subnet_t c = {.owner = &bar, .type = SUBNET_IPV4, .net = {.ipv4 = ipv4_1},};
...
static void test_subnet_compare_ipv6_weight(void **state) {
	...
	const subnet_t a = {.type = SUBNET_IPV6, .weight = 1, .net = {.ipv6 = ipv6_1}};
	const subnet_t b = {.type = SUBNET_IPV6, .weight = 2, .net = {.ipv6 = ipv6_1}};
...
static void test_subnet_compare_ipv6_owners(void **state) {
	...
	const subnet_t a = {.owner = &foo, .type = SUBNET_IPV6, .net = {.ipv6 = ipv6_1}};
	const subnet_t b = {.owner = &foo, .type = SUBNET_IPV6, .net = {.ipv6 = ipv6_1}};
	const subnet_t c = {.owner = &bar, .type = SUBNET_IPV6, .net = {.ipv6 = ipv6_1}};
