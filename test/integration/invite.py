...
from testlib import Test, log, Script, check, util


def run_invite_test(t: Test, start_before_invite: bool):
...
with Test("offline mode") as t:
    run_invite_test(t, start_before_invite=False)

with Test("online mode") as t:
    run_invite_test(t, start_before_invite=True)
