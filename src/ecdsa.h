...
extern ecdsa_t *ecdsa_set_base64_public_key(const char *p) ATTR_MALLOC ATTR_CONSTRUCTOR(ecdsa_free);
extern ecdsa_t *ecdsa_read_pem_public_key(FILE *fp) ATTR_MALLOC ATTR_CONSTRUCTOR(ecdsa_free);
extern ecdsa_t *ecdsa_read_pem_private_key(FILE *fp) ATTR_MALLOC ATTR_CONSTRUCTOR(ecdsa_free);
