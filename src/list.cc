...
list_t *list_alloc(list_action_t release) {
	list_t *list = static_cast<list_t *>(xzalloc(sizeof(list_t)));
...
list_node_t *list_alloc_node(void) {
	return static_cast<list_node_t *>(xzalloc(sizeof(list_node_t)));
}

void list_free_node(list_t *list, list_node_t *node) {
	if(node->data && list->release) {
