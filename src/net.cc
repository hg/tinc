...
static void timeout_handler(void *data) {
	...
	*/
	...
	timeval tv{1, jitter()};
	timeout_set(static_cast<timeout_t *>(data), &tv);
}
...
int main_loop(void) {
	...
	timeval ping_timeout{pingtimeout, jitter()};
	timeout_add(&pingtimer, timeout_handler, &pingtimer, &ping_timeout);

	timeval zero_timeout{};
	timeout_add(&periodictimer, periodic_handler, &periodictimer, &zero_timeout);
