...
extern splay_tree_t *splay_alloc_tree(splay_compare_t compare, splay_action_t delete) ATTR_CONSTRUCTOR(splay_free_tree);

extern void splay_free_node(splay_tree_t *tree, splay_node_t *node);
extern splay_node_t *splay_alloc_node(void) ATTR_MALLOC ATTR_CONSTRUCTOR(splay_free_node);
